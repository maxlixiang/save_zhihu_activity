# Claude Code + GLM-5 + Superpowers 保姆级入门教程

---

> 这是一篇写给**纯小白**的 Claude Code 教程，如果你已经是 Claude Code 高手，请直接划走，不要浪费时间~  
> 也不要点个收藏就划走了，要看完！要动起手来！收藏了你是不会再看的！！！
**目标**：在 Windows 系统上，从零开始安装并配置 Claude Code，接入的 GLM-5 模型，快速上手 AI 编程。（进阶用户可选装 Superpowers 插件解锁更强大的工作流）
**适合人群**：
* Windows 用户
* 完全零基础的小白
* 想要体验 AI 编程效率提升的非开发者
...
2. **免费模型**：GLM-5 —— 编码*能力强、国内访问友好、coding plan 量大*
3. **基础环境**：Node.js —— *一次安装，多处通用*
4. **进阶插件（可选）**：Superpowers —— *给 AI 装上”工程之魂”*
---
![](%5B2026-01-21_12-33%5D%20Claude%20Code%20%2B%20GLM-5%20%2B%20Superpowers%20%E4%BF%9D%E5%A7%86%E7%BA%A7%E5%85%A5%E9%97%A8%E6%95%99%E7%A8%8B_%E5%9B%BE%E7%89%87/_1775634568184.jpg)
...
**安装步骤：**
1. 访问 [Node.js 官网](https://link.zhihu.com/?target=https%3A//nodejs.org/)
...
**安装步骤：**
1. 访问 [Git 官网](https://link.zhihu.com/?target=https%3A//git-scm.com/downloads)
2. 下载 Windows 版本
3. 双击安装包
...
---
## 第四部分：配置 GLM-5 模型
安装 Claude Code 后，我们需要配置 GLM-5 模型。GLM-5 是智谱 AI 出品的最新大模型，对中文支持非常好，且国内访问友好。
### 通过 GLM Coding Plan 配置（推荐）
这是最简单的方式，智谱提供了专门的配置工具。
1. 访问 [GLM Coding Plan 官网](https://link.zhihu.com/?target=https%3A//www.bigmodel.cn/)
2. 注册/登录账号
3. 获取 GLM Coding Plan 的订阅
4. 按照官方文档配置环境变量
---
...
1. 检查 JSON 格式是否正确（不能有多余的逗号）
2. **关闭所有 Claude Code 窗口，重新打开一个新的 PowerShell 窗口**
3. 启动 Claude Code 后，输入 `/status` 查看模型状态
...
3. 重启 Claude Code
### Q5: 如何切换模型？
**方法 1：修改配置文件** 编辑 `C:\Users\你的用户名\.claude\settings.json`，修改 `env` 部分的模型名称。
**方法 2：使用命令**
```
/model
```
...
## 第十部分：学习资源
### 官方文档
* **Claude Code 官网**：[https://code.claude.com](https://link.zhihu.com/?target=https%3A//code.claude.com/)
* **Claude Code 文档**：[https://code.claude.com/docs](https://link.zhihu.com/?target=https%3A//code.claude.com/docs)
* **GLM Coding Plan**：[https://docs.bigmodel.cn/cn/coding-plan](https://link.zhihu.com/?target=https%3A//docs.bigmodel.cn/cn/coding-plan)
### Superpowers 项目
* **GitHub 仓库**：[https://github.com/obra/superpowers](https://link.zhihu.com/?target=https%3A//github.com/obra/superpowers)
...
![](%5B2026-01-21_12-33%5D%20Claude%20Code%20%2B%20GLM-5%20%2B%20Superpowers%20%E4%BF%9D%E5%A7%86%E7%BA%A7%E5%85%A5%E9%97%A8%E6%95%99%E7%A8%8B_%E5%9B%BE%E7%89%87/_1775634568359.jpg)
![](%5B2026-01-21_12-33%5D%20Claude%20Code%20%2B%20GLM-5%20%2B%20Superpowers%20%E4%BF%9D%E5%A7%86%E7%BA%A7%E5%85%A5%E9%97%A8%E6%95%99%E7%A8%8B_%E5%9B%BE%E7%89%87/_1775634568716.jpg)
### 我想说的是什么？
**AI 不是来替代程序员的，AI 是来让每个人都有机会成为创造者的。**
以前，编程是少数人的专利。 现在，编程变成了每个人的超能力。
你不需要懂算法，不需要会调试，甚至不需要知道什么叫 API。 你只需要有一个想法，然后告诉 AI：”帮我做个XX小程序”
它会帮你写代码、帮你改 bug、帮你上架。 你唯一要做的，就是**专注你的创意**。
---
### 还在犹豫什么？
> 在微信搜索「**千禧时光机**」或「**我们的纪念册**」体验一下完全由 AI 开发的小程序吧！ 或许很快，你的小程序也会出现在这里~
---
## 进阶推荐：解锁更强大的 GLM-5
...
### 真实使用数据
这是我近 30 天的 GLM 使用情况：
![](%5B2026-01-21_12-33%5D%20Claude%20Code%20%2B%20GLM-5%20%2B%20Superpowers%20%E4%BF%9D%E5%A7%86%E7%BA%A7%E5%85%A5%E9%97%A8%E6%95%99%E7%A8%8B_%E5%9B%BE%E7%89%87/_1775634568923.jpg)
**接近 20 亿 token！** 这足以证明 GLM-5 的强大和实惠。高频使用下依然性价比超高，完全不用担心成本问题。
**速来拼好模，智谱 GLM Coding 超值订阅，邀你一起薅羊毛！**
**立即了解：**[智谱AI开放平台](https://link.zhihu.com/?target=https%3A//www.bigmodel.cn/glm-coding%3Fic%3DIDSZ0TALCT)
> 从免费版到进阶版，GLM-5 会成为你编程路上的最强外挂！
---
**开始操练你的 AI 打工人吧！**
关联阅读：[Claude Code -- Burn Your Money：一个专门让你"看着钱燃烧"的插件](https://zhuanlan.zhihu.com/p/1998520711329891549)